...
function calcAptitude(stallion, race) {
  ...
  if(stallion.distanceMin==="VERSATILE"||stallion.distanceMax==="VERSATILE"){
    ...
    const centerFit=1-distFromCenter/maxDistFromCenter;
